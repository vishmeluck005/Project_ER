...
public class MC3112RulePage extends TestBase {
	...
	@FindBy(xpath="//span[@class='fancytree-title'][normalize-space()='Account Number']")
	...
	public void createNewRule() throws  InterruptedException, AWTException {
		Thread.sleep(5000);
		newRuleBtn.click();
		selectCharacteristicsSearchBox.sendKeys("account number");
